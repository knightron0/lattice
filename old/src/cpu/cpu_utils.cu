...
__host__ void add_cpu(Lattice* lattice1, Lattice* lattice2, float* res_dat) {
...
__host__ void matmul_cpu(Lattice* lattice1, Lattice* lattice2, float* res_dat) {
...
__host__ void broadcast_add_cpu(Lattice* lattice, Lattice* lattice_col, int* broadcast_shapes, float* res_dat) {
